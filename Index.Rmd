---
title: "Lecture 1: Introductions, recaptions and planned work"
...
Type of intepretation usually depends on the strenght of the theoretical framework and methodological design. If you have a well developed theoretical assumptions and experimental design, this perhasp allows you to use counterfactual interpretation.  
...
???
The model summarises difference in average Height between the children that vary in their Age and Gender. <br/> <br/>

Intercept is the average (prediction) score for girls (0 on Gender variable) and that have 0 months in their Age
...
???
Additional reading on type of dummy codding in R: [link](https://stats.idre.ucla.edu/r/modules/coding-for-categorical-variables-in-regression-models/)
---
...
Gender: Expected difference between girls who are 0 months old and boys who are 0 months old is $\beta_2$ coefficient<br/> <br/>

Age*Gender: Difference in the Age slope for Girls and Boys
???
Mean for the Boys, when Age is 0: Intercept + $Gender_{boys}$<br/> <br/>
...
+ a good sign is when the main effects are relatively strong and large and they explain large amount of variation in the data
---
...
???
In this situation, I am primarily using correlation to summarise collected data. High correlations might prepare me for collinearity issues in regressions, unexpected changes in the coefficients etc.  
---
...
d) Stay the same, never change <br/> <br/>
3. How good you are with Exploratory Factor Analysis? <br/><br/>
a) What is exploratory factor analysis?<br/>
b) I know basics <br/>
c) I would know how to build, interpret and write up EFA results
